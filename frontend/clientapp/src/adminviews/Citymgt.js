...
function Citymgt()
{
    ...
    const handleSaveButton=()=>{
        ...
        if(ctid==""||ctid==undefined||ctname==""||ctname==undefined ||stid==""||
            stid==undefined||status==""||status==undefined ||stid=="0")
            {
                ...
                axios.get("http://localhost:9191/city/searchbyname/"+ctname).then
                ((res)=>{
    ...
    const handleUpdateButton=()=>{
        if(ctid==""||ctid==undefined||ctname==""||ctname==undefined||status==""||
            status==undefined||stid==""||stid==undefined)
            {
                alert("Please Fill All Fields");
                return;
            }
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       value={ctid} className="form-control"/>
                                    </td> 
                                    </tr>                           
                                    <tr>
                                    <td>City Name</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        className="form-control"value={stid}><option value="0">Select State</option>
                                            {
                                                stlist.map((item)=>(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" onClick={handleShowButton}className="btn btn-secondary"
                                        >Show</button>
                                    </td>
                                    <td>
                                ...
                                </tr>
                                {
                                    ctlist.map((item)=>(
                                        <tr>
                                            ...
                                            <td>
                                                {item.status==1 ?
                                            <h5>enabled</h5>:<h5>disable</h5>}</td>
                                        </tr>
                                    ))
                                }
                            </table>
