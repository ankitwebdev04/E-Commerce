...
function Statemgt()
{
    ...
    const handleSaveButton=()=>{
        if(stid==""||stid==undefined||stname==""||
            stname==undefined||status==""||status==undefined)
            {
    ...
    const handleUpdateButton=()=>{
        if(stid==""||stid==undefined||stname==""||stname==undefined||status==""||
            status==undefined)
            {
                alert("Please Fill All Fields");
                return;
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                   ...
                                   value={stid} className="form-control"/>
                                </td> 
                                </tr>                           
                                <tr>
                                <td>State Name</td>
